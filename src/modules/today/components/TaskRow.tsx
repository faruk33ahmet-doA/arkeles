...
/*
 * TaskRow — Anayasa madde 8.1, 8.3.
 *
 * SPRINT 0 KISITI: checkbox GÖRÜNÜR AMA PASİF.
 * Sebep: mekanik yazma altyapısı (atomic write + çakışma kontrolü, madde 20)
 ...
 *
 * Bu yüzden `disabled` ve `aria-disabled` açıkça verilir — sessizce
